%% 
function [d,w, fval, Sfinal, COVIJ, covij] = core_graspQ(P, lambda, iterMAX, P0, P1)
%{
    Some problems:
...
%{
    ...
    SP500assetsP1 = P1.initialAssetList;
    %}
    x = [];
    fval = 1000;
    Sfinal = [];
    ...
    feasible = 0; %feasible solution found
    ...
    while (itrGRASP <= itrMAX_GRASP)
        ...
        toc = cputime - t0; 
        fprintf('iteration %d elapsed time: %fs\tMeanTPI: %fs\n\n', itrGRASP-1, toc, (cputime - T0)/(itrGRASP-1));
    end
