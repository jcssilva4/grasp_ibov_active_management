function [A, b] = getLinCon_qp(P, S, Cmat, samplePeriodSize, teta)
%using di as x
    nAssets = length(S);
    ...
    for t = 1:samplePeriodSize
        ...
        b(auxc) = - lowerTeta - Cmat(t,length(P.initialAssetList)+1); %get rhs
        auxc = auxc + 1;
    end
    ...
    for t = 1:samplePeriodSize
        ...
        b(auxc) = upperTeta + Cmat(t,length(P.initialAssetList)+1); %get rhs
        auxc = auxc + 1;
    end
    %{
